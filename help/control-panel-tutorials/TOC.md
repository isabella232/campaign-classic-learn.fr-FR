...
+ Paramètres des instances {#instance-settings}
   ...
   + Gestion des clés GPG {#gpg-key-management}
      ...
      + [Utilisation d&#39;une clé GPG pour le chiffrement des données](/help/control-panel-tutorials/instance-settings/gpg-key-management/using-a-gpg-key-to-encrypt-data.md)
